    ...
    namespace RebirthStudios.DataAccessLayer
{
    public class DataTableSelects
    {
        ...
        public List<DataRow> PlayersAccountsSelectRows(string userName, string password)
        {
            ...
            {
                foreach (var item in _dataTables.PlayersAccountsDataTable.Select($"{PlayersAccountsColumns.userName}='{userName}' AND {PlayersAccountsColumns.password}='{password}'", "", DataViewRowState.CurrentRows))
                {
                    rows.Add(item);
                }
            }
        ...
        public List<DataRow> PlayersAccountsSelectRows(string userName)
        {
            ...
            {
                foreach (var item in _dataTables.PlayersAccountsDataTable.Select($"{PlayersAccountsColumns.userName}='{userName}'", "", DataViewRowState.CurrentRows))
                {
                    rows.Add(item);
                }
            }
        ...
        public Dictionary<byte, DataRow> EntityTypesSelectRows_Dictionary()
        {
            Dictionary<byte, DataRow> rows = new Dictionary<byte, DataRow>();
                ...
                {
                    rows.Add((byte)eT[(byte)EntityTypesColumns.entityTypeId],eT);
                }
            return rows;
        }
        ...
        public Dictionary<byte, DataRow> InteractableTypesSelectRows_Dictionary()
        {
            ...
            foreach (var iT in _dataTables.InteractableTypesDataTable.Select("", "", DataViewRowState.CurrentRows))
            {
                rows.Add((byte)iT[(byte)InteractableTypesColumns.interactableTypeId],iT);
            }
            return rows;
        }
        public List<DataRow> ItemSubTypesSelectRows(byte? itemSubTypeId = null)
        {
            ...
            {
                foreach (var iST in _dataTables.ItemSubTypesDataTable.Select($"{ItemSubTypesColumns.itemSubTypeId}='{itemSubTypeId.Value}'", "", DataViewRowState.CurrentRows))
                {
                    rows.Add(iST);
                }
            }
        ...
        public List<DataRow> ItemTypesSelectRows(byte? itemTypeId = null)
        {
            ...
            {
                foreach (var row in _dataTables.ItemTypesDataTable.Select($"{ItemTypesColumns.itemTypeId}='{itemTypeId.Value}'", "", DataViewRowState.CurrentRows))
                {
                    rows.Add(row);
                }
            }
        ...
        public List<DataRow> ScriptableAbilitiesRanksActivationCostsSelectRows(string globalObjectCode)
        {
            ...
            {
                foreach (var item in _dataTables.ScriptableAbilitiesRanksActivationCostsDataTable.Select($"{ScriptableAbilitiesRanksActivationCostsColumns.globalObject}='{globalObjectCode}'", "", DataViewRowState.CurrentRows))
                {
                    rows.Add(item);
                }
            }
            ...
            string password, string emailAddress, string salt, string lastIpAddressOnLogin, DateTime lastLoginTime)
        {
            ...
            pA[(byte)PlayersAccountsColumns.admin] = false;
            return pA;
        }
        //CHARACTERS

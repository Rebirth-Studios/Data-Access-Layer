...
namespace RebirthStudios.DataAccessLayer
{
    ...
    public class DataTables : IDisposable
    {
        ...
        private const string AbilityRanksToObjectRanksMappingTableName = "abilityRanksToObjectRanksMapping";
        ...
        private const string ScriptableAbilitiesRanksTableName = "scriptableAbilitiesRanks";
        public DataTable ScriptableAbilitiesRanksDataTable;
        
        private const string ScriptableAbilitiesRanksActivationCostsTableName = "scriptableAbilitiesRanksActivationCosts";
...
#region SET DEFAULT VIEW SORT
        ...
        private void FillReferenceDataSet()
        {
            ...
            IconsDataTable = FillTable(_dataSet, IconsTableName); 
            PrefabsDataTable = FillTable(_dataSet, PrefabsTableName); 
        ...
        private void FillScriptableDataSet()
        {
            ...
            ScriptableAbilitiesRanksDataTable = FillTable(_dataSet, ScriptableAbilitiesRanksTableName);
            ScriptableAbilitiesRanksActivationCostsDataTable = FillTable(_dataSet, ScriptableAbilitiesRanksActivationCostsTableName);
            AbilityRanksToObjectRanksMappingDataTable = FillTable(_dataSet, AbilityRanksToObjectRanksMappingTableName);
            // LOOT TABLES
        ...
        private void FillDictionaries()
        {
            ...
            EffectsToEffectGroupsMappingDictionaryByEffectGlobalObjectCode = EffectsToEffectGroupsMappingDataTable.ToDictionary<string, string>(EffectsToEffectGroupsMappingColumns.effectGlobalObject.ToString(), EffectsToEffectGroupsMappingColumns.effectGroupGlobalObject.ToString());
            EffectsToEffectGroupsMappingDictionaryByEffectGroupGlobalObjectCode = EffectsToEffectGroupsMappingDataTable.ToDictionary<string, string>(EffectsToEffectGroupsMappingColumns.effectGroupGlobalObject.ToString(), EffectsToEffectGroupsMappingColumns.effectGlobalObject.ToString());
            EffectGroupsToObjectsMappingDictionary = EffectGroupsToObjectsMappingDataTable.ToDictionary<string, byte>(
                EffectGroupsToObjectsMappingColumns.scriptableObjectGlobalObject.ToString(),
            ...
            PlayersAccountsDictionaryByUserName = PlayersAccountsDataTable.ToDictionary<string>(PlayersAccountsColumns.userName.ToString());
            ...
            ScriptableAbilitiesRanksActivationCostsDictionary         = ScriptableAbilitiesRanksActivationCostsDataTable.ToDictionary_KeyKey_Nested<string, byte>(ScriptableAbilitiesRanksActivationCostsColumns.globalObject.ToString(), ScriptableAbilitiesRanksActivationCostsColumns.rankId.ToString());
            ...
            ScriptableLootTableRaritiesDictionaryByGlobalObjectCode   = ScriptableLootTableRaritiesDataTable.ToDictionary<string,string,byte>(ScriptableLootTableRaritiesColumns.globalObject.ToString(),ScriptableLootTableRaritiesColumns.itemGlobalObject.ToString(), ScriptableLootTableRaritiesColumns.rarityId.ToString());

CREATE TABLE [content].[ammunitionSubTypes] (
    ...
    CONSTRAINT [ammunitionSubTypes_pk] PRIMARY KEY CLUSTERED ([typeId] ASC),
    CONSTRAINT [UQ__ammuniti__7754D46AF713934E] UNIQUE NONCLUSTERED ([type] ASC)
);

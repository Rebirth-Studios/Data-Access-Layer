CREATE TABLE [content].[bagTypes] (
    ...
    CONSTRAINT [bagTypes_pk] PRIMARY KEY CLUSTERED ([typeId] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [bagTypes_bagTypeId_uindex]
    ON [content].[bagTypes]([typeId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [bagTypes_bagType_uindex]
    ON [content].[bagTypes]([type] ASC);

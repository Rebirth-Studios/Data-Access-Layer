CREATE TABLE [content].[consumableClassificationTypes] (
    ...
    CONSTRAINT [PK__consumab__2902B5E7479838DF] PRIMARY KEY CLUSTERED ([typeId] ASC),
    CONSTRAINT [consumableClassificationTypes_consumableTypes_consumableTypeId_fk] FOREIGN KEY ([parentTypeId]) REFERENCES [content].[consumableTypes] ([typeId])
);

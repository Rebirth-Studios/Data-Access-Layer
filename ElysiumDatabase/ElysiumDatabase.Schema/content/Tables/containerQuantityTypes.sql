CREATE TABLE [content].[containerQuantityTypes] (
    ...
    CONSTRAINT [containerQuantityTypes_pk] PRIMARY KEY CLUSTERED ([typeId] ASC),
    CONSTRAINT [UQ__containe__815D80EC1AD13677] UNIQUE NONCLUSTERED ([type] ASC)
);

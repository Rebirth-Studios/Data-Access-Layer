...
-- =============================================
CREATE procedure [dbo].[spCharacter_MailClaimCurrency]
...
BEGIN TRY 
	...
	SET currencyClaimed = 1
	WHERE charactersMailId = @charactersMailId
	SET @updateMailCount = @@rowcount
	
	--SET CUSTOM ERROR MESSAGE FOR DEBUGGING
	IF (@updateMailCount = 0) SET @errCustomMessage = 'NO INSERT MADE'
	IF (@updateMailCount > 1) SET @errCustomMessage = 'MULTIPLE INSERTS MADE WHICH SHOULD NOT BE POSSIBLE!!!'

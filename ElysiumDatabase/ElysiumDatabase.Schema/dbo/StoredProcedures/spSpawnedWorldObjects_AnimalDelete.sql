...
-- Description: Deletes spawned Animal world object (spawnedWorldObjectId)
-- =============================================
CREATE PROCEDURE [dbo].[spSpawnedWorldObjects_AnimalDelete]
...
BEGIN TRY
    ...
    DELETE FROM [runtime].[spawnedAnimals] WHERE spawnedWorldObjectId = @spawnedWorldObjectId

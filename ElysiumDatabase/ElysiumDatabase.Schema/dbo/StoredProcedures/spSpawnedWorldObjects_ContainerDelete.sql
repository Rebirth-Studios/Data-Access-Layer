...
-- Author: Eric Ingram
-- Create date: 2021
-- Updated 12/22/2021: Added logging
-- Updated: 02/26/2022 - Added @batchRowId
-- Description: Used to delete container objects
-- =============================================
CREATE PROCEDURE [dbo].[spSpawnedWorldObjects_ContainerDelete]
...
BEGIN TRY
	...
	SET @insertBatchProcessingCount = @@rowcount
		...
		--DELETE FROM SPAWNED TABLES
			DELETE FROM [runtime].[spawnedContainers] WHERE spawnedWorldObjectId = @spawnedWorldObjectId

...
-- Description: Deletes spawned Enemy Humanoid world object (spawnedWorldObjectId)
-- =============================================
CREATE PROCEDURE [dbo].[spSpawnedWorldObjects_EnemyHumanoidDelete]
...
DECLARE
	...
	@deleteSpawnedContainersCount tinyint,
	@deleteSpawnedInteractablesCount tinyint,
	@deleteSpawnedWorldObjectsCount tinyint
BEGIN TRY
	...
	--SET @storedProcedureName = 'spSpawnedWorldObjects_EnemyHumanoidDelete'
    ...
    DELETE FROM [runtime].[spawnedEnemyHumanoids] WHERE spawnedWorldObjectId = @spawnedWorldObjectId
    SET @deleteSpawnedContainersCount = @@rowcount
    DELETE FROM [runtime].[spawnedEntities] WHERE spawnedWorldObjectId = @spawnedWorldObjectId

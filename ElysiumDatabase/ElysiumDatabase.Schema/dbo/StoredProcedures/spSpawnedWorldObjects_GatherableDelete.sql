...
-- Description: Deletes spawned Gatherable world object (spawnedWorldObjectId)
-- =============================================
CREATE PROCEDURE [dbo].[spSpawnedWorldObjects_GatherableDelete]
...
BEGIN TRY		
	...
	--SET @storedProcedureName = 'spSpawnedWorldObjects_GatherableDelete'
    ...
    DELETE FROM [runtime].[spawnedGatherables] WHERE spawnedWorldObjectId = @spawnedWorldObjectId

...
-- Description: Deletes spawned Monster world object (spawnedWorldObjectId)
-- =============================================
CREATE PROCEDURE [dbo].[spSpawnedWorldObjects_MonsterDelete]
	@spawnedWorldObjectId uniqueIdentifier,
	@logging bit,
	@batchRowId smallint = 0,
...
BEGIN TRY
	...
	--SET @storedProcedureName = 'spSpawnedWorldObjects_MonsterDelete'
    ...
    DELETE FROM [runtime].[spawnedMonsters] WHERE spawnedWorldObjectId = @spawnedWorldObjectId

    ...
    public class DataTableStoredProcs :   IDisposable
    {
        ...
        #region Tables
         ...
         internal static Dictionary<int, EnumData> ApplicationTypes_GetList()
         {
             ...
             {
                 var applicationTypeId = (byte)aT[(byte)ApplicationTypesColumns.typeId];
                 var applicationType   = (string)aT[(byte)ApplicationTypesColumns.type];
         ...
         internal static Dictionary<int, EnumData> AbilityTypes_GetList()
         {
             ...
             {
                 var abilityTypeId = (byte)aT[(byte)AbilityTypesColumns.typeId];
                 var abilityType = (string)aT[(byte)AbilityTypesColumns.type];
                 var abilityTypeName = (string)aT[(byte)AbilityTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> AbilityEffectTypes_GetList()
         {
             ...
             {
                 var abilityEffectTypeId = (byte)aEt[(byte)AbilityEffectTypesColumns.typeId];
                 var abilityEffectType = (string)aEt[(byte)AbilityEffectTypesColumns.type];
                 var abilityEffectTypeName = (string)aEt[(byte)AbilityEffectTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> AbilityCostTypes_GetList()
         {
             ...
             {
                 var costTypeId   = (byte)cT[(byte)CostTypesColumns.typeId];
                 var costType     = (string)cT[(byte)CostTypesColumns.type];
                 var costTypeName = (string)cT[(byte)CostTypesColumns.typeName];
                 var description  = (string)cT[(byte)CostTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> ArmorTypes_GetList()
         {
             ...
             {
                 var armorTypeId = (byte)aT[(byte)ArmorTypesColumns.typeId];
                 var armorType = (string)aT[(byte)ArmorTypesColumns.type];
                 var armorTypeName = (string)aT[(byte)ArmorTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> CalcStatTypes_GetList()
         {
            ...
            {
                 var interactableTypeId = (byte)sT[(byte)StatCalculatedTypesColumns.typeId];
                 var stat = (string)sT[(byte)StatCalculatedTypesColumns.type];
                 var statName = (string)sT[(byte)StatCalculatedTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> ContainerTypes_GetList()
         {
             ...
             {
                 var containerTypeId   = (byte)cT[(byte)ContainerTypesColumns.typeId];
                 var containerType     = (string)cT[(byte)ContainerTypesColumns.type];
                 var containerTypeName = (string)cT[(byte)ContainerTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> BagTypes_GetList()
         {
             ...
             {
                 var consumableTypeId = (byte)cT[(byte)ConsumableTypesColumns.typeId];
                 var consumableType = (string)cT[(byte)ConsumableTypesColumns.type];
                 var consumableTypeName = (string)cT[(byte)ConsumableTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> EntityTypes_GetList()
         {
             ...
             {
                 byte entityTypeId = (byte)eT[(byte)EntityTypesColumns.typeId];
                 string entityType = (string)eT[(byte)EntityTypesColumns.type];
                 string entityTypeName = (string)eT[(byte)EntityTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> AnimalTypes_GetList()
         {
             ...
             {
                 byte animalTypeId = (byte)aT[(byte)AnimalTypesColumns.typeId];
                 string animalType = (string)aT[(byte)AnimalTypesColumns.type];
                 string animalTypeName = (string)aT[(byte)AnimalTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> AnimalClassificationTypes_GetList()
         {
             ...
             {
                 byte animalClassificationTypeId = (byte)aST[(byte)AnimalClassificationTypesColumns.typeId];
                 string animalClassificationType = (string)aST[(byte)AnimalClassificationTypesColumns.type];
                 string animalClassificationTypeName = (string)aST[(byte)AnimalClassificationTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> AnimalSubTypes_GetList()
         {
             ...
             {
                 byte animalSubTypeId = (byte)aST[(byte)AnimalSubTypesColumns.typeId];
                 string animalSubType = (string)aST[(byte)AnimalSubTypesColumns.type];
                 string animalSubTypeName = (string)aST[(byte)AnimalSubTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> EnemyHumanoidTypes_GetList()
         {
             ...
             {
                 byte enemyHumanoidTypeId = (byte)eHT[(byte)EnemyHumanoidTypesColumns.typeId];
                 string enemyHumanoidType = (string)eHT[(byte)EnemyHumanoidTypesColumns.type];
                 string enemyHumanoidTypeName = (string)eHT[(byte)EnemyHumanoidTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> EnemyHumanoidClassificationTypes_GetList()
         {
             ...
             {
                 byte enemyHumanoidSubTypeId = (byte)eHST[(byte)EnemyHumanoidSubTypesColumns.typeId];
                 string enemyHumanoidSubType = (string)eHST[(byte)EnemyHumanoidSubTypesColumns.type];
                 string enemyHumanoidSubTypeName = (string)eHST[(byte)EnemyHumanoidSubTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> MonsterTypes_GetList()
         {
             ...
             {
                 byte   monsterTypeId   = (byte)mT[(byte)MonsterTypesColumns.typeId];
                 string monsterType     = (string)mT[(byte)MonsterTypesColumns.type];
                 string monsterTypeName = (string)mT[(byte)MonsterTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> MonsterClassificationTypes_GetList()
         {
             ...
             {
                 byte monsterSubTypeId = (byte)mST[(byte)MonsterSubTypesColumns.typeId];
                 string monsterSubType = (string)mST[(byte)MonsterSubTypesColumns.type];
                 string monsterSubTypeName = (string)mST[(byte)MonsterSubTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> EffectTypes_GetList()
         {
             ...
             {
                 byte effectTypeId = (byte)cST[(byte)EffectTypesColumns.typeId];
                 string effectType = (string)cST[(byte)EffectTypesColumns.type];
                 string effectTypeName = (string)cST[(byte)EffectTypesColumns.typeName];
                 string description = (string)cST[(byte)EffectTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> CostTypes_GetList()
         {
             ...
             {
                 byte costTypeId = (byte)eCT[(byte)CostTypesColumns.typeId];
                 string costType = (string)eCT[(byte)CostTypesColumns.type];
                 string costTypeName = (string)eCT[(byte)CostTypesColumns.typeName];
                 string description = (string)eCT[(byte)CostTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> AbilityActivationTypes_GetList()
         {
             ...
             {
                 byte abilityActivationTypeId = (byte)eCT[(byte)AbilityActivationTypesColumns.typeId];
                 string abilityActivationType = (string)eCT[(byte)AbilityActivationTypesColumns.type];
         ...
         internal static Dictionary<byte, SubEnumData> ConsumableClassificationTypes_GetList()
         {
             ...
             {
                 byte consumableSubTypeId = (byte)cST[(byte)ConsumableSubTypesColumns.typeId];
                 string consumableSubType = (string)cST[(byte)ConsumableSubTypesColumns.type];
                 string consumableSubTypeName = (string)cST[(byte)ConsumableSubTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> MaterialClassificationTypes_GetList()
         {
             ...
             {
                 byte materialSubTypeId = (byte)mST[(byte)MaterialSubTypesColumns.typeId];
                 string materialSubType = (string)mST[(byte)MaterialSubTypesColumns.type];
                 string materialSubTypeName = (string)mST[(byte)MaterialSubTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> GeneralItemTypes_GetList()
         {
             ...
             {
                 byte   generalItemTypeId   = (byte)gIT[(byte)GeneralItemTypesColumns.typeId];
                 string generalItemType     = (string)gIT[(byte)GeneralItemTypesColumns.type];
                 string generalItemTypeName = (string)gIT[(byte)GeneralItemTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> GeneralItemClassificationTypes_GetList()
         {
             ...
             {
                 byte generalItemSubTypeId = (byte)gIT[(byte)GeneralItemSubTypesColumns.typeId];
                 string generalItemSubType = (string)gIT[(byte)GeneralItemSubTypesColumns.type];
                 string generalItemSubTypeName = (string)gIT[(byte)GeneralItemSubTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> ArmorSlotTypes_GetList()
         {
             ...
             {
                 byte   armorSlotTypeId = (byte)aST[(byte)ArmorSlotTypesColumns.typeId];
                 string armorSlotType = (string)aST[(byte)ArmorSlotTypesColumns.type];
                 string armorSlotTypeName = (string)aST[(byte)ArmorSlotTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> AwardEffectTypes_GetList()
         {
             ...
             {
                 byte awardEffectTypeId = (byte)aST[(byte)AwardEffectTypesColumns.typeId];
                 string awardEffectType = (string)aST[(byte)AwardEffectTypesColumns.type];
                 string awardEffectTypeName = (string)aST[(byte)AwardEffectTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> EquipmentTypes_GetList()
         {
             ...
             {
                 var equipmentTypeId = (byte)eT[(byte)EquipmentTypesColumns.typeId];
                 var equipmentType = (string)eT[(byte)EquipmentTypesColumns.type];
                 var equipmentTypeName = (string)eT[(byte)EquipmentTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> EquipmentSlotTypes_GetList()
         {
             ...
             {
                 var equipmentSlotTypeId = (byte)eT[(byte)EquipmentSlotTypesColumns.typeId];
                 var equipmentSlotType = (string)eT[(byte)EquipmentSlotTypesColumns.type];
         ...
         internal static Dictionary<int, EnumData> ExperienceEffectTypes_GetList()
         {
             ...
             {
                 var experienceEffectTypeId = (byte)eEt[(byte)ExperienceEffectTypesColumns.typeId];
                 var experienceEffectType = (string)eEt[(byte)ExperienceEffectTypesColumns.type];
                 var experienceEffectTypeName = (string)eEt[(byte)ExperienceEffectTypesColumns.typeName];
                 var description = (string)eEt[(byte)ExperienceEffectTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> GatherableTypes_GetList()
         {
             ...
             {
                 var gatherableTypeId = (byte)gT[(byte)GatherableTypesColumns.typeId];
                 var gatherableType = (string)gT[(byte)GatherableTypesColumns.type];
                 var gatherableTypeName = (string)gT[(byte)GatherableTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> GatherableClassificationTypes_GetList()
         {
             ...
             {
                 var gatherableClassificationTypeId = (byte)gT[(byte)GatherableClassificationTypesColumns.typeId];
                 var gatherableClassificationType = (string)gT[(byte)GatherableClassificationTypesColumns.type];
                 var gatherableClassificationTypeName = (string)gT[(byte)GatherableClassificationTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> GatherableSubTypes_GetList()
         {
             ...
             {
                 var gatherableSubTypeId = (byte)gT[(byte)GatherableSubTypesColumns.typeId];
                 var gatherableSubType = (string)gT[(byte)GatherableSubTypesColumns.type];
                 var gatherableSubTypeName = (string)gT[(byte)GatherableSubTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> GlobalStatuses_GetList()
         {
             ...
             {
                 var statusId = (byte)gOt[(byte)GlobalStatusesColumns.typeId];
                 var status = (string)gOt[(byte)GlobalStatusesColumns.type];
                 var statusName = (string)gOt[(byte)GlobalStatusesColumns.typeName];
                 var statusDescription = (string)gOt[(byte)GlobalStatusesColumns.description];
         ...
         internal static Dictionary<int, EnumData> GlobalObjectTypes_GetList()
         {
             ...
             {
                 var objectTypeId = (byte)gOT[(byte)GlobalObjectTypesColumns.typeId];
                 var objectType = (string)gOT[(byte)GlobalObjectTypesColumns.type];
                 var objectTypeName = (string)gOT[(byte)GlobalObjectTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> ScriptableObjectTypes_GetList()
         {
             ...
             {
                 var scriptableObjectTypeId = (byte)sOT[(byte)ScriptableObjectTypesColumns.typeId];
                 var scriptableObjectType = (string)sOT[(byte)ScriptableObjectTypesColumns.type];
                 var scriptableObjectTypeName = (string)sOT[(byte)ScriptableObjectTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> InteractableTypes_GetList()
         {
             ...
             {
                 var interactableTypeId = (byte)iT[(byte)InteractableTypesColumns.typeId];
                 var interactableType = (string)iT[(byte)InteractableTypesColumns.type];
                 var interactableTypeName = (string)iT[(byte)InteractableTypesColumns.typeName];
                 var description = (string)iT[(byte)InteractableTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> ItemTypes_GetList()
         {
             ...
             {
                 var itemTypeId = (byte)iT[(byte)ItemTypesColumns.typeId];
                 var itemType = (string)iT[(byte)ItemTypesColumns.type];
                 var itemTypeName = (string)iT[(byte)ItemTypesColumns.typeName];
                 var description = (string)iT[(byte)ItemTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> LootTableTypes_GetList()
         {
             ...
             {
                 var lootTableTypeId = (byte)lT[(byte)LootTableTypesColumns.typeId];
                 var lootTableType = (string)lT[(byte)LootTableTypesColumns.type];
                 var lootTableTypeName = (string)lT[(byte)LootTableTypesColumns.typeName];
         ...
         internal static Dictionary<byte, SubEnumData> LootTableSubTypes_GetList()
         {
             ...
             {
                 var lootTableSubTypeId = (byte)lSt[(byte)LootTableSubTypesColumns.typeId];
                 var lootTableSubType = (string)lSt[(byte)LootTableSubTypesColumns.type];
                 var lootTableSubTypeName = (string)lSt[(byte)LootTableSubTypesColumns.typeName];
                 var description = (string)lSt[(byte)LootTableSubTypesColumns.description];
                 var lootTableTypeId = (byte)lSt[(byte)LootTableSubTypesColumns.parentTypeId];
         ...
         internal static Dictionary<int, EnumData> MaterialTypes_GetList()
         {
             ...
             {
                 var materialTypeId = (byte)mT[(byte)MaterialTypesColumns.typeId];
                 var materialType = (string)mT[(byte)MaterialTypesColumns.type];
                 var materialTypeName = (string)mT[(byte)MaterialTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> ModifierTypes_GetList()
         {
             ...
             {
                 var materialModifierTypeId = (byte)mT[(byte)ModifierTypesColumns.typeId];
                 var materialModifierType = (string)mT[(byte)ModifierTypesColumns.type];
                 var materialModifierTypeName = (string)mT[(byte)ModifierTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> NpcTypes_GetList()
         {
             ...
             {
                 byte   npcTypeId   = (byte)nT[(byte)NpcTypesColumns.typeId];
                 string npcType     = (string)nT[(byte)NpcTypesColumns.type];
                 string npcTypeName = (string)nT[(byte)NpcTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> QualityTypes_GetList()
         {
             ...
             {
                 var qualityId = (byte)sR[(byte)ScriptableQualitiesColumns.typeId];
                 var quality = (string)sR[(byte)ScriptableQualitiesColumns.type];
                 var qualityName = (string)sR[(byte)ScriptableQualitiesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> QuestCategoryTypes_GetList()
         {
             ...
             {
                 var questCategoryTypeId = (byte)qCt[(byte)QuestCategoryTypesColumns.typeId];
                 var questCategoryType = (string)qCt[(byte)QuestCategoryTypesColumns.type];
                 var questCategoryTypeName = (string)qCt[(byte)QuestCategoryTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> QuestObjectiveTypes_GetList()
         {
             ...
             {
                 var questObjectiveTypeId = (byte)qOt[(byte)QuestObjectiveTypesColumns.typeId];
                 var questObjectiveType = (string)qOt[(byte)QuestObjectiveTypesColumns.type];
                 var questObjectiveTypeName = (string)qOt[(byte)QuestObjectiveTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> AdventuringQuestTypes_GetList()
         {
             ...
             {
                 var adventuringQuestTypeId = (byte)aQt[(byte)AdventuringQuestTypesColumns.typeId];
                 var adventuringQuestType = (string)aQt[(byte)AdventuringQuestTypesColumns.type];
                 var adventuringQuestTypeName = (string)aQt[(byte)AdventuringQuestTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> GatheringQuestTypes_GetList()
         {
             ...
             {
                 var gatheringQuestTypeId = (byte)gQt[(byte)GatheringQuestTypesColumns.typeId];
                 var gatheringQuestType = (string)gQt[(byte)GatheringQuestTypesColumns.type];
                 var gatheringQuestTypeName = (string)gQt[(byte)GatheringQuestTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> RequirementTypes_GetList()
         {
             ...
             {
                 var requirementTypeId = (byte)gQt[(byte)RequirementTypesColumns.typeId];
                 var requirementType = (string)gQt[(byte)RequirementTypesColumns.type];
                 var requirementTypeName = (string)gQt[(byte)RequirementTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> CraftingQuestTypes_GetList()
         {
             ...
             {
                 var craftingQuestTypeId = (byte)cQt[(byte)CraftingQuestTypesColumns.typeId];
                 var craftingQuestType = (string)cQt[(byte)CraftingQuestTypesColumns.type];
                 var craftingQuestTypeName = (string)cQt[(byte)CraftingQuestTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> RarityTypes_GetList()
         {
             ...
             {
                 var rarityTypeId = (byte)sR[(byte)ScriptableRaritiesColumns.typeId];
                 var rarity = (string)sR[(byte)ScriptableRaritiesColumns.type];
                 var rarityName = (string)sR[(byte)ScriptableRaritiesColumns.typeName];
                 var rarityDescription = (string)sR[(byte)ScriptableRaritiesColumns.description];
         ...
         internal static Dictionary<int, EnumData> BaseStatTypes_GetList()
         {
             ...
             {
                 var statId = (byte) sT[(byte)StatBaseTypesColumns.typeId];
                 var stat = (string) sT[(byte)StatBaseTypesColumns.type];
                 var statName = (string) sT[(byte)StatBaseTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> StatMultiplierTypes_GetList()
         {
             ...
             {
                 var statId = (byte) sT[(byte)StatMultiplierTypesColumns.typeId];
                 var stat = (string) sT[(byte)StatMultiplierTypesColumns.type];
                 var statName = (string) sT[(byte)StatMultiplierTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> BodyPartTypes_GetList()
         {
             ...
             {
                 var bodyPartTypeId = (byte)sT[(byte)BodyPartTypesColumns.typeId];
                 var bodyPartType       = (string)sT[(byte)BodyPartTypesColumns.type];
         ...
         internal static Dictionary<int, EnumData> StatTypes_GetList()
         {
             ...
             {
                 var statTypeId = (byte)sT[(byte)StatTypesColumns.typeId];  
                 var statType = (string)sT[(byte)StatTypesColumns.type];
                 var statTypeName = (string)sT[(byte)StatTypesColumns.typeName];
                 var description = (string)sT[(byte)StatTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> SkillTypes_GetList()
         {
             ...
             {
                 var skillTypeId = (byte)sT[(byte)SkillTypesColumns.typeId];
                 var skillType = (string)sT[(byte)SkillTypesColumns.type];
                 var skillTypeName = (string)sT[(byte)SkillTypesColumns.typeName];
                 var description = (string)sT[(byte)SkillTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> UnlockEffectTypes_GetList()
         {
             ...
             {
                 var unlockEffectTypeId   = (byte)uEt[(byte)UnlockEffectTypesColumns.typeId];
                 var unlockEffectType     = (string)uEt[(byte)UnlockEffectTypesColumns.type];
                 var unlockEffectTypeName = (string)uEt[(byte)UnlockEffectTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> EffectAmountTypes_GetList()
         {
             ...
             {
                 var effectTypeId   = (byte)eT[(byte)EffectTypesColumns.typeId];
                 var effectType     = (string)eT[(byte)EffectTypesColumns.type];
                 var effectTypeName = (string)eT[(byte)EffectTypesColumns.typeName];
                 var description    = (string)eT[(byte)EffectTypesColumns.description];
         ...
         internal static Dictionary<int, EnumData> WeaponSlotTypes_GetList()
         {
             ...
             {
                 var weaponSlotId   = (byte)wS[(byte)WeaponSlotTypesColumns.typeId];
                 var weaponSlot     = (string)wS[(byte)WeaponSlotTypesColumns.type];
                 var weaponSlotName = (string)wS[(byte)WeaponSlotTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> WeaponTypes_GetList()
         {
             ...
             {
                 var weaponTypeId   = (byte)wT[(byte)WeaponTypesColumns.typeId];
                 var weaponType     = (string)wT[(byte)WeaponTypesColumns.type];
                 var weaponTypeName = (string)wT[(byte)WeaponTypesColumns.typeName];
         ...
         internal static Dictionary<int, EnumData> WorldObjectTypes_GetList()
         {
             ...
             {
                 var worldObjectTypeId = (byte)wOt[(byte)WorldObjectTypesColumns.typeId];
                 var worldObjectType = (string)wOt[(byte)WorldObjectTypesColumns.type];
                 var worldObjectTypeName = (string)wOt[(byte)WorldObjectTypesColumns.typeName];
         ...
         public static PlayerAccountRequestResponse PlayerAccount_GetPassword(string userName, string password)
         {
             ...
             admin     = (bool) (pA[(byte)PlayersAccountsColumns.isAdmin]);
...
//             //throw new NotImplementedException();
             ...
             string eyeColor, string hairColor, string stubbleColor, float spawnLocationX, float spawnLocationY, float spawnLocationZ)
         {
             ...
             try
             {
                 ...
                 for (int i = 1; i < equipmentLocations.Length; i++)
                 {
                     ...
                     byte equipmentLocationId = (byte)eST[(byte)EquipmentSlotTypesColumns.typeId];
          ...
          float durabilityPercentage, bool wasCrafted, string crafterName, bool wasLooted, Guid spawnedWorldObjectId, Guid instancedItemId)
        {
            ...
            try
            {
                ...
                else if (itemTypeId == (byte)ItemTypes.Equipment)
                {
                    ...
                    else if (itemSubTypeId == (byte) EquipmentTypes.Jewelry) 
                    {
                        Instance._dataTableSelects.AddInstancedArmorDataRow(instancedItemId, globalObject);
                        success = true;
                    }
        ...
        public static Dictionary<string, List<AbilityRankModel>> Abilities_RanksGetList()
        {
            ...
            {
                string globalObject = (string)(sAR[(byte)ScriptableAbilitiesLevelsColumns.globalObject]);
                byte rankId           = (byte) sAR[(byte)ScriptableAbilitiesLevelsColumns.levelId];
                if (Instance._dataTables.ScriptableAbilitiesRanksActivationCostsDictionary.ContainsKey(globalObject))
                {
                    ...
                    var activateWhileMoving = (bool)sAR[(byte)ScriptableAbilitiesLevelsColumns.activateWhileMoving];
                    var damageCancels = (bool)eG[(byte)EffectGroupsColumns.damageCancels];
                    var castTime = (float)(decimal)sAR[(byte)ScriptableAbilitiesLevelsColumns.activationTime];
                    var effectCostTypeId = (byte)sArac[(byte)ScriptableAbilitiesLevelsActivationCostsColumns.costTypeId];
                    var effectCostStatId = (byte)sArac[(byte)ScriptableAbilitiesLevelsActivationCostsColumns.statId];
                    var effectCostStatTypeId = (byte)sArac[(byte)ScriptableAbilitiesLevelsActivationCostsColumns.statTypeId];
                    var duration = (int)eG[(byte)EffectGroupsColumns.duration];
                    var cost = (int)sArac[(byte)ScriptableAbilitiesLevelsActivationCostsColumns.cost];
                    var cooldown = (int)sAR[(byte)ScriptableAbilitiesLevelsColumns.cooldown];    
        ...
        public static Dictionary<string, LootTableModel> LootTables_GetList()
        {
            ...
            foreach (DataRow sLt in Instance!._dataTables.ScriptableLootTablesDataTable.Rows)
            {
                ...
                //var lootTableSubTypeId   = (byte)sLt[ScriptableLootTablesColumns.lootTableMainTypeId];
                var llobalObjectTypeId   = (byte)glO[(byte)GlobalObjectsColumns.globalObjectTypeId];

                LootTableModel lootTable = new LootTableModel(globalObject, globalStatusId, lootTableName, scriptableObjectPath, lootTableTypeId, 0, llobalObjectTypeId);
        ...
        public static List<QualityModel> Qualities_GetList()
        {
            ...
            {
                var qualityId = (byte)sQ[(byte)ScriptableQualitiesColumns.typeId];
                var       qualityName     = (string)sQ[(byte)ScriptableQualitiesColumns.typeName];
        ...
        public static List<RarityModel> Rarities_GetList()
        {
            ...
            foreach (DataRow sR in Instance!._dataTables.ScriptableRaritiesDataTable.Select())
            {
                var         rarityId        = (byte)sR[(byte)ScriptableRaritiesColumns.typeId];
                var         rarityName      = (string)sR[(byte)ScriptableRaritiesColumns.typeName];
        ...
        public static Dictionary<string, List<ushort>> StatEffects_GetList()
        {
            ...
            foreach (DataRow eGtim in Instance!._dataTables.EffectGroupsToItemsMappingDataTable.Rows)
            {
                ...
                string globalObject = (string)eGtim[(byte)EffectGroupsToItemsMappingColumns.itemGlobalObject];
            ...
            foreach (var sE in Instance!._dataTables.StatEffectsDictionary)
            {
                ...
                if (Instance._dataTables.EffectsToEffectGroupsMappingDictionaryByEffectGlobalObjectCode.ContainsKey(globalObject))
                {
                    ...
                    foreach (var eTegm in nestedEffectGlobalObjects)
                    {
                        ...
                        var statusEffectAmount = (decimal)sE.Value[(byte)StatEffectsColumns.statEffectAmount];
        ...
        public static Dictionary<string, SkillModel> Skills_GetList()
        {
            ...
            foreach (DataRow sK in Instance!._dataTables.ScriptableSkillsDataTable.Rows)
            {
                ...
                var skillCategoryTypeId = (byte)sK[(byte)ScriptableSkillsColumns.skillCategoryTypeId];
        ...
        public static List<KillTotalModel> ScriptableTotals_KillsGetList()
        {
            ...
            foreach (DataRow sTK in Instance!._dataTables.ScriptableTotalsKillsDataTable.Rows) 
            {
                ...
                var entityTierId = (byte) sTK[(byte)ScriptableTotalsKillColumns.killTierId];
        ...
        public static List<QuestLineModel> ScriptableQuests_GetQuestLines()
        {
            ...
            foreach (DataRow sQ in Instance!._dataTables.ScriptableQuestlinesDataTable.Rows) 
            {
                ...
                string questLineName        = (string)sQ[(byte)ScriptableQuestlinesColumns.globalObjectName];
                string scriptableObjectPath = (string)sO[(byte)ScriptableObjectsColumns.scriptableObjectPath];
        ...
        public static Dictionary<string, Dictionary<byte, List<StatModel>>> ScriptableWorldObjects_StatsGetList()
        {
            ...
            foreach (DataRow eS in Instance!._dataTables.EntityStatsDataTable.Rows)
            {
                ...
                var rankId = (byte)(eS[(byte)EntityStatsColumns.levelId]);
        ...
        public static List<InteractableModel> ScriptableWorldObjects_BankGetList()
        {
            ...
            foreach (DataRow sI in Instance!._dataTables.ScriptableInteractablesDataTable.Select())
            {
                ...
                var    scriptableObjectTypeId     = (byte) sO[(byte)ScriptableObjectsColumns.scriptableObjectTypeId];
       ...
       public static Dictionary<string, EnemyHumanoidModel> ScriptableWorldObjects_EnemyHumanoidsGetList()
            ...
            uint locationId, Guid spawnedWorldObjectId)
        {
            ...
            try
            {
                ...
                var            glO            = Instance._dataTables.GlobalObjectsDictionary[animalGlobalObject];
                var globalTierId = (byte)glO[(byte)GlobalObjectsColumns.globalTierId];
            ...
            uint locationId, Guid spawnedWorldObjectId)
        {
            ...
            try
            {
                ...
                DataRow sWO = dataScriptableWorldObjects[0];
                //var     globalTierId = (byte)sWO[(byte)ScriptableWorldObjectsColumns.globalTierId];
                var            glO            = Instance._dataTables.GlobalObjectsDictionary[interactableGlobalObject];
                var globalTierId = (byte)glO[(byte)GlobalObjectsColumns.globalTierId];
            ...
            uint locationId, Guid spawnedWorldObjectId)
        {
            ...
            try
            {
                ...
                DataRow sWO = dataScriptableWorldObjects[0];
                //var     globalTierId = (byte)sWO[(byte)ScriptableWorldObjectsColumns.globalTierId];
                var            glO            = Instance._dataTables.GlobalObjectsDictionary[enemyHumanoidGlobalObject];
                var globalTierId = (byte)glO[(byte)GlobalObjectsColumns.globalTierId];
        ...
        uint locationId, Guid spawnedWorldObjectId)
        {
            ...
            try
            {
                ...
                DataRow sWO = dataScriptableWorldObjects[0];
                //var globalTierId = (byte)sWO[(byte)ScriptableWorldObjectsColumns.globalTierId];
                var            glO            = Instance._dataTables.GlobalObjectsDictionary[monsterGlobalObject];
                var globalTierId = (byte)glO[(byte)GlobalObjectsColumns.globalTierId];
            ...
            byte rank, byte variationId, string prefabId, bool ignoreSpawnTable, uint locationId, Guid spawnedWorldObjectId, byte npcTypeId)
        {
            ...
            try
            {
                ...
                DataRow sWO = dataScriptableWorldObjects[0];
                //var globalTierId = (byte)sWO[(byte)ScriptableWorldObjectsColumns.globalTierId];
                var            glO            = Instance._dataTables.GlobalObjectsDictionary[npcGlobalObject];
                var globalTierId = (byte)glO[(byte)GlobalObjectsColumns.globalTierId];

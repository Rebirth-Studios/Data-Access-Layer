...
{{
	...
	{{
        ...
        private static string assemblyDirectory = AppDomain.CurrentDomain.BaseDirectory;
        private static string projectDirectory = Directory.GetParent(assemblyDirectory).Parent.FullName;
        private static string solutionDirectory = Directory.GetParent(projectDirectory).FullName;
